...
return function(p)
	return {
		...
		degrees_f32_heating_start_ambient_temp = p.degrees_f32_heating_start_ambient_temp,
		kw_f32_thermal_power                   = p.kw_f32_thermal_power,
		kw_f32_electric_power                  = p.kw_f32_electric_power
	}
end
